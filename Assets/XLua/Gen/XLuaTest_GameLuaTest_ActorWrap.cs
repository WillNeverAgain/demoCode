...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaTestGameLuaTestActorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XLuaTest.GameLuaTest.Actor);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 4 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4))
				{
					...
					var gen_ret = new XLuaTest.GameLuaTest.Actor(_uuid, _x, _y);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XLuaTest.GameLuaTest.Actor constructor!");
        ...
        static int _g_get_Uuid(RealStatePtr L)
        {
		    try {
                ...
                XLuaTest.GameLuaTest.Actor gen_to_be_invoked = (XLuaTest.GameLuaTest.Actor)translator.FastGetCSObj(L, 1);
